...
//        System.out.println("isValid = " + isValidName.negate().and(m -> m.startsWith("D")).test("Dinesh"));
...
//                .peek(LampdaExpression::accept) // Used to log each element
...
//                .noneMatch(number -> number > 5) // RETURNS BOOLEAN
...
//        var collectString = String.join(",", users);
    ...
    private static void accept(String peeked) {
