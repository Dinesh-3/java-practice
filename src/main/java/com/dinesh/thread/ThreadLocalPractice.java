 ...
 * Next, when we want to use this value from a thread, we only need to call a get() or set() method. Simply put,
 * we can imagine that ThreadLocal stores data inside of a map with the thread as the key.
 */
